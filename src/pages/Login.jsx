...
function Login() {
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '50px auto', padding: '25px', border: '1px solid #e0e0e0', borderRadius: '8px', backgroundColor: '#fff', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', fontFamily: 'Arial, sans-serif' }}>
      <h2 style={{ color: '#2c3e50', textAlign: 'center', marginBottom: '10px' }}>Iniciar Sesión</h2>
      <p style={{ color: '#7f8c8d', fontSize: '13px', textAlign: 'center', marginBottom: '20px' }}>Smart Estate - Portal Real</p>
      ...
      <form onSubmit={manejarLogin} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '15px', fontSize: '14px', color: '#7f8c8d' }}>
          ¿No tienes cuenta?{' '}
          <Link 
            to="/register" 
            style={{ color: '#3498db', fontWeight: 'bold', textDecoration: 'underline', cursor: 'pointer' }}
          >
            Regístrate aquí
          </Link>
        </p>
