  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
      ...
      <p style={{ color: '#7f8c8d', marginBottom: '25px' }}>
        ¿Tienes dudas sobre alguna propiedad o quieres publicar tu inmueble? Déjanos tu mensaje.
      </p>
      ...
      <form onSubmit={manejarEnvio} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <div>
          <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '14px' }}>Mensaje o Consulta</label>
          <textarea 
            rows="5"
            required
            value={mensaje}
