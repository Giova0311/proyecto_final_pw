...
function AddProperty() {
  ...
  useEffect(() => {
    ...
    if (
      !usuarioLogueado ||
      (usuarioLogueado.role !== "owner" && usuarioLogueado.role !== "admin")
    ) {
      navigate("/login");
    } else {
  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#7f8c8d", marginBottom: "25px", fontSize: "14px" }}>
        Propietario: <strong>{user.name}</strong>
      </p>
      ...
      {exito && (
        ...
        >
          🎉 ¡Anuncio guardado con éxito en MySQL! Ya está disponible en el
      ...
      >
        <div style={{ gridColumn: "1 / span 2" }}>
          ...
          <input
            ...
            placeholder="Ej: Penthouse con vista panorámica"
          />
        </div>
        ...
        <div style={{ gridColumn: "1 / span 2" }}>
          ...
          <textarea
            ...
            placeholder="Detalles sobre alcobas, baños, zonas sociales..."
          ></textarea>
        </div>
